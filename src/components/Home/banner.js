...
import slider1 from '../../src/img/slider-1.png';
import slider2 from '../../src/img/slider-2.png';
import slider3 from '../../src/img/slider-3.png';
          ...
          <div className="row  d-flex align-items-center justify-content-center">
            <div className="header-left col-lg-5 col-md-6 ">
              ...
              <p className="pt-10 pb-10">
                WAGNON est en Afrique un des principaux acteurs pour la protection de l’environnement utilisant 
                l’un des moyens le plus précieux aux yeux des peuples : leur culture.
              </p>
            ...
            <img className="img-fluid w-100" src={slider1} alt=""/>
            <img className="img-fluid w-100" src={slider2} alt=""/>
            <img className="img-fluid w-100" src={slider3} alt=""/>
            </div>
            <div className="form-wrap">
            <p className="mb-20 text-white">Faire un don</p>
            <form className="form"  autoComplete="off">
            <div className="row">
            <div className="col-md-7 wrap-left donation-input">
            ...
            <div className="col-md-5 wrap-right">
            <div className="input-group dates-wrap">
            <button type="button" className="primary-btn white" onClick = {() => {setModal(true)}}>Donner</button>
            </div>
            </div>
            </div>
            </form>
